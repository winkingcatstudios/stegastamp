...
var encode = function() {
    ...
    if (message.length > maxMessageSize) {
        alert('Message is too long, please enter your name and creative license code. See step 2 for more details.');
        return;
    }
    ...
    // view the new image
    alert('Step 2 complete. When the image appears, right click to save it and proceed to step 3.');
